...
export const PrivacyPolicyView = () => {
    return (
        <article style={{padding: 8}}>
            ...
            <p>Poniższa Polityka Prywatności jest integralną częścią <a href="https://retro.newbies.pl/privacy">Regulaminu Serwisu</a>, który określa zasady, prawa i obowiązki Użytkowników korzystających z Serwisu.</p>

            <h2 style={{textAlign: "center"}}>§1 Definicje</h2>
            <ul>
                <li><p><strong>Serwis</strong> - serwis internetowy "Retromachina" działający pod adresem https://retro.newbies.pl</p></li>
                ...
                <li><p><strong>Administrator Serwisu / Danych</strong> - Administratorem Serwisu oraz Administratorem Danych (dalej Administrator) jest osoba fizyczna "Wiktor Petryszyn" zamieszkała w Wrocławiu, świadcząca usługi drogą elektroniczną za pośrednictwem Serwisu</p></li>
            ...
            <ul>
                ...
                <li><p><strong>Cookies sesyjne</strong> - pliki zamieszczane i odczytywane z Urządzenia Użytkownika przez Serwis podczas jednej sesji danego Urządzenia. Po zakończeniu sesji pliki są usuwane z Urządzenia Użytkownika.</p></li>
            ...
            <ul>
                ...
                <li><p><strong>Kontrola plików Cookie</strong>
                    <ul>
            ...
            <ul id="cele"><li>Usprawnienie i ułatwienie dostępu do Serwisu</li>
            ...
            <ul>
                <li><p><strong>Adres poczty elektronicznej</strong> - newbies@rst.com.pl</p></li>
            </ul>
